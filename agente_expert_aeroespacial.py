...
def start_Completion(question):
    ...
    system_message = f"Você é um assistente Expert em engenharia espacial. Você oferecerá insights sobre o valor do ruído obtido por um set de parâmetros de um aerofólio. Máximo de 200 caracteres."
    questions = question
    questions = [
        {"user": questions}
    ]
